...
public class 실습01 {
	...
	public static void main(String[] args) {
		...
		long d1=214748364, d2=1L<<63,d3=(1L<<63)-1;
		...
		System.out.printf("%.1f, %.1f , %.1f",e,f1,f2);
		System.out.println(g1+","+String.valueOf(h1)+","+String.valueOf(h2)+","+String.valueOf(h3)+","+String.valueOf(h4));
		System.out.println();
